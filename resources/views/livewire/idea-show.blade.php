<div class="idea-and-buttons container">
            ...
            <div class="w-full md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div class="flex items-center md:hidden mt-4 md:mt-0">
                        ...
                        @if($hasVoted)
                            <button class="w-20 text-white bg-blue border-blue font-bold text-xxs uppercase rounded-xl hover:bg-blue-hover transition duration-150 ease-in px-4 py-3 -mx-5">
                                Voted
                            </button>
                        @else
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
                <button type="button" class="w-32 h-11 text-white bg-blue border-blue hover:bg-blue-hover transition duration-150 ease-in rounded-xl focus:outline-none focus:ring-2 focus:ring-blue focus:border-transparent font-semibold text-xs px-6 py-3">
